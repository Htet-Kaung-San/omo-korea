...
- **유학 준비생**: MBTI·관심 분야·언어 실력 기반 학과 추천 AI, 나라별 서류 체크리스트, 장학 정보, Agency 정보 제공
- **재학생**: 수강 과목 추천 AI, 졸업요건 체크리스트, 캠퍼스 맵, 학교 시설 가이드, 커뮤니티 게시판
...
- 국가별 비자 신청 서류 체크리스트 자동 생성 및 진행 상황 트래킹, 마감일 임박 알림
- GKS(정부초청장학금)·대학 자체 장학금 등 사용자 조건 맞춤형 장학 정보 통합 제공
- 국가별 인증 MOB Agency 정보 및 주의 에이전시 경보 제공
- 준비생 전용 커뮤니티 게시판 (재학생 멘토와의 Q&A 채널)
**② 재학생 기능**
