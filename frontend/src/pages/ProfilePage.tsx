      ...
      <div className="flex min-h-[calc(100dvh-56px)] flex-col bg-pnu-surface">
        ...
        <form onSubmit={handleSave} className="space-y-4 px-4 py-5">
          ...
          <Card className="space-y-3 p-4">
            ...
            >
              <option value="">{t("profile.selectVisa")}</option>
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <Card>
            ...
            <p className="mt-1 text-sm font-semibold text-pnu-text truncate">
              {user?.visaStatus || t("profile.none")}
            </p>
          </Card>
        </div>
        ...
        <div className="space-y-3.5 border-t border-pnu-border/40 pt-4 mt-2">
          ...
          <div className="grid grid-cols-2 gap-3 mt-3 border-t border-pnu-border/40 pt-4">
            <div className="space-y-1.5 text-left">
              <label className="block text-sm font-medium text-pnu-text">{t("profile.intakeYear")}</label>
            ...
            <div className="space-y-1.5 text-left">
              <label className="block text-sm font-medium text-pnu-text">{t("profile.intakeTerm")}</label>
              <select
                value={intakeTerm}
              ...
              >
                <option value="March">{t("profile.intakeSpring")}</option>
                <option value="September">{t("profile.intakeFall")}</option>
              </select>
            </div>
          </div>
