      ...
      >
        ...
        <div className="flex-1 px-5">
          ...
          <button
            ...
            className="mt-4 mb-6 w-full rounded-xl border border-dashed border-pnu-border bg-white/60 px-4 py-3 text-left text-xs text-pnu-muted hover:border-pnu-blue-light/40 hover:bg-white transition-colors"
          >
