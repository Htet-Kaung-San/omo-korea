...
const TRANSLATION_CATALOG = {
  ...
  'Submit Health Clearance Certificate to Dormitory': entry({
    en: 'Submit Health Clearance Certificate to Dormitory',
    ko: '기숙사에 건강진단서 제출',
    zh: '向宿舍提交健康证明',
    vi: 'Nộp giấy chứng nhận sức khỏe cho ký túc xá',
    ja: '寮への健康診断書の提出',
    my: 'အိပ်ဆောင်သို့ ကျန်းမာရေး စစ်ဆေးမှုလက်မှတ် တင်သွင်းရန်',
    th: 'ยื่นใบรับรองสุขภาพให้หอพัก',
    id: 'Serahkan surat keterangan kesehatan ke asrama',
    es: 'Entregar el certificado de salud a la residencia',
    ru: 'Сдать медицинскую справку в общежитие',
    tr: 'Yurda sağlık belgesi teslim edin',
    ur: 'ڈارمیٹری کو ہیلتھ کلیئرنس سرٹیفکیٹ جمع کروائیں',
    hi: 'छात्रावास में स्वास्थ्य प्रमाणपत्र जमा करें',
    bn: 'হোস্টেলে স্বাস্থ্য ছাড়পত্র জমা দিন',
    fa: 'تحویل گواهی سلامت به خوابگاه',
    uz: "Yotoqxonaga sog‘liq haqidagi guvohnoma topshiring",
    kk: 'Жатақханаға денсаулық анықтамасын тапсырыңыз',
    mn: 'Дотуур байранд эрүүл мэндийн гэрчилгээ өгөх',
    am: 'የጤና ማረጋገጫ ወደ ማረፊያ ቤት ያስረክቡ',
  }),
};
